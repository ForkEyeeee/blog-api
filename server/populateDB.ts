  ...
  const postData = [
    {
      ...
      content:
        "Nature has always fascinated humankind. From the towering mountains to the gentle streams, nature showcases its beauty in myriad ways. The changing seasons, the blooming flowers, and the mesmerizing sunsets are just a few examples of the beauty that nature offers.",
    },
    {
      title: "Exploring the World of AI",
      content:
        "Artificial Intelligence is shaping the future. From automation to predicting patterns, AI offers vast possibilities. Its influence on various industries, including healthcare, finance, and entertainment, has been revolutionary.",
    },
    {
      title: "Adventures in the Himalayas",
      content:
        "The Himalayas stand tall, representing the pinnacle of nature's grandeur. Trekking through its terrains gives a unique experience, offering both challenges and spectacular views. The rich flora and fauna found here are unparalleled.",
    },
    {
      title: "The Mysterious Oceans",
      content:
        "Oceans cover the majority of our planet, yet we've explored only a fraction of them. The deep blue waters hide mysteries waiting to be discovered. From colorful corals to diverse marine life, oceans are nature's treasure trove.",
    },
    {
      title: "Journey through Middle Earth",
      content:
        "Middle Earth, a creation of J.R.R. Tolkien, is a land of fantasy. From the Shire to Mordor, it's filled with diverse landscapes, cultures, and stories. The epic tales of heroism, friendship, and adventure are timeless.",
    },
  ];
